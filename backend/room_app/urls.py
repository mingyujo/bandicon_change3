...
urlpatterns = [
    ...
    path('<int:pk>/verify_password/', views.VerifyRoomPasswordView.as_view(), name='room-verify-password'),
    path('<int:pk>/image/', views.RoomImageUploadView.as_view(), name='room-image-upload'),

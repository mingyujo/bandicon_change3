    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(db_index=True, help_text='서비스에서 사용할 고유한 별명', max_length=150, unique=True)),
                ('phone', models.CharField(blank=True, max_length=20, null=True)),
                ('phone_verified', models.BooleanField(default=False)),
                ('email_verified', models.BooleanField(default=False)),
                ('skills', models.JSONField(blank=True, null=True)),
                ('manner_score', models.CharField(default='루키', max_length=20)),
                ('badges', models.IntegerField(default=0)),
                ('profile_img', models.CharField(blank=True, max_length=512, null=True)),
                ('role', models.CharField(default='멤버', max_length=20)),

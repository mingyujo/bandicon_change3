...
urlpatterns = [
    ...
    # --- 👇 [이동] 내 스크랩/글/댓글 URL (순서 중요: board_type 보다 위에 위치) ---
    ...
    path('clan/<int:clan_id>/hot-posts/', views.ClanHotPostListView.as_view(), name='clan-hot-posts'),
    # 댓글
    ...
    path('comments/<int:comment_pk>/like/', views.CommentToggleLikeView.as_view(), name='comment-toggle-like'),
]
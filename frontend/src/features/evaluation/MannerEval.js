    ...
    <div style={{ padding: "20px", maxWidth: '600px', margin: 'auto' }}>
      ...
      {participants.length === 0 ? (
        ...
        <>
          ...
          {/* [디버깅용] 데이터 확인 */}
          <div style={{ marginTop: '30px', padding: '10px', background: '#f8f9fa', border: '1px solid #ddd', fontSize: '0.8em' }}>
            <strong>Page Debug Info:</strong>
            <br />Room ID: {roomId}
            <br />Title: "{roomTitle}"
            <br />Participants: {JSON.stringify(participants)}
            <br />My Nickname: {user.nickname}
          </div>
        </>
      )}
    </div>
